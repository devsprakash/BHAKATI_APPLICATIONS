...
const { signup_validator, ValidatorResult, temple_login_validator, get_profile_temple_validator, update_temple_profile_validator, create_live_streaming_validator,
    ...
    add_bank_validator } = require('../../validation/temple.validator')
...
router.post('/updateProfileImage', upload.fields([{ name: 'profile_image', maxCount: 1 }, { name: 'background_image', maxCount: 1 }]), TempleAuth, updateProfileImage);
